...
\begin{document}
    ...
    \section{Profil}
        ...
        \begin{onecolentry}
            Actuellement à la recherche d'un stage de fin d'études (PFE) d'une durée de 4 à 6 mois, à partir de février 2024, dans le domaine de l'ingénierie informatique.
        \end{onecolentry}
